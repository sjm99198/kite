...
public class PartsListView {
	...
	// 게시글의 리스트
	private List<PartsArticleVo> list;
	// 전체 게시글의 개수
	...
	public PartsListView(List<PartsArticleVo> list, int totalArticleCount, int currentPageNo, int startRow,
			int countPerPage) {
		this.list = list;
	...
	public List<PartsArticleVo> getList() {
		return list;
	}
