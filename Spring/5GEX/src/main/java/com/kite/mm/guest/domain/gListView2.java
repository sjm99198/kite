...
public class gListView2 {

	// 게시글의 리스트
	private List<gArticleVo> list;
	// 전체 게시글의 개수
	...
	public gListView2(List<gArticleVo> list, int totalArticleCount, int currentPageNo, int startRow,
			int countPerPage) {
		this.list = list;
	...
	public List<gArticleVo> getList() {
		return list;
	}
